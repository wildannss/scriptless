...
curl -s -X POST https://api.telegram.org/bot1899238854:AAH0tUYroXQLLmDw-sED2lzlE-ao2UpUbzM/sendMessage -d chat_id=277081400 -d text="Backup Interserver Mulai"
...
curl -s -X POST https://api.telegram.org/bot1899238854:AAH0tUYroXQLLmDw-sED2lzlE-ao2UpUbzM/sendMessage -d chat_id=277081400 -d text="Backup Semua Interserver Config RClone Mulai"
...
curl -s -X POST https://api.telegram.org/bot1899238854:AAH0tUYroXQLLmDw-sED2lzlE-ao2UpUbzM/sendMessage -d chat_id=277081400 -d text="Backup Semua Interserver Config RClone Selesai"

curl -s -X POST https://api.telegram.org/bot1899238854:AAH0tUYroXQLLmDw-sED2lzlE-ao2UpUbzM/sendMessage -d chat_id=277081400 -d text="Backup Semua Interserver File SH Mulai"
mkdir -p /root/gd_bu/.sh
chmod +x /root/gd_bu/.sh
\cp -avrf /root/*.sh /root/gd_bu/.sh/
zip -r /root/gd_bu/.sh.zip /root/gd_bu/.sh
curl -s -X POST https://api.telegram.org/bot1899238854:AAH0tUYroXQLLmDw-sED2lzlE-ao2UpUbzM/sendMessage -d chat_id=277081400 -d text="Backup Semua Interserver File SH Selesai"

rclone copy --progress --drive-acknowledge-abuse --update --local-no-check-updated --ignore-checksum /root/gd_bu/ ws-onedrive:Server/Backup/Interserver

rm -rf /root/bekap_json/
rm -rf /root/gd_bu

curl -s -X POST https://api.telegram.org/bot1899238854:AAH0tUYroXQLLmDw-sED2lzlE-ao2UpUbzM/sendMessage -d chat_id=277081400 -d text="Backup Interserver Selesai"
